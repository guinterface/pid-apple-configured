  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
        child: Text("Recomendamos que apenas adicione medicamentos segundo recomendação médica", style: TextStyle(fontSize: 12),
        ),),
      Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
        child: new InkWell(
            child: new Text('Para mais informações, clique aqui'),
            onTap: () => launchUrl(Uri.parse('https://bvsms.saude.gov.br/uso-de-medicamentos-orientacoes/'))
        ),),
