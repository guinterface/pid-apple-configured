            ...
            child: Column(
              children: <Widget>[
                ...
                Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
                  child: Text("O cálculo de IMC é uma verificação de saúde, disponível em:", style: TextStyle(fontSize: 12),
                  ),),
                Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
                  child: new InkWell(
                      child: new Text('Cálculo de imc'),
                      onTap: () => launchUrl(Uri.parse('https://www.saude.rj.gov.br/obesidade/calcule-seu-imc#:~:text=Trouxemos%20uma%20calculadora%20para%20tirar,da%20altura%20(em%20metros).'))
                  ),),
