      ...
      body: Container(
        ...
        Padding(padding: EdgeInsets.all(10)),
                ...
                Padding(padding:EdgeInsets.only(top: 5, left: 12),
                  child: Text("Pontos de caloria totais hoje: $_calorias", style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20, color: Colors.blueAccent),
                  ),),
            Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
              child: Text("1 ponto equivale a aproximadamente 3,6 calorias. Para dados nutricionais completos verificados, acesse:", style: TextStyle(fontSize: 12),
              ),),
            Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
              child: new InkWell(
                child: new Text('Tabela Brasileira de Composição de Alimentos', style: TextStyle( decoration: TextDecoration.underline, color: Colors.blueAccent),),
        onTap: () => launchUrl(Uri.parse('https://www.cfn.org.br/wp-content/uploads/2017/03/taco_4_edicao_ampliada_e_revisada.pdf',))
    ),),
            ...
            /*Padding(padding:EdgeInsets.only(top: 2, left: 12, bottom: 10),
              child: Text("É recomendado que um objetivo diário seja definido por orientação médica", style: TextStyle(fontSize: 12),
              ),),*/
              Padding(
                padding: EdgeInsets.only(bottom: 5,top: 10,  left: 18, right: 18),
                child: TextField(
            ...
            Padding(padding:EdgeInsets.only(bottom: 7, left: 12, top: 10),
